    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse d-md-flex flex-md-column align-items-end flex-sm-column-reverse"
            ...
            @if (auth('client')->check())
                ...
                <div class="d-flex align-items-center gap-3 ms-auto ms-md-auto locale-user-wrap">

                    <div class="dropdown">
                        <div class="d-flex align-items-center gap-1 btn dropdown-toggle" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="h-100 w-100 overflow-hidden">
                                <img src="{{ asset('images/profile.png') }}" alt="">
                            </div>
                            <p class="text-white fw-light d-flex gap-1 align-items-center">
                                {{ __('site.welcome') }}, <span
                                    class="fw-bold">{{ auth('client')->user()->name }}</span>
                                <i class="fas fa-chevron-down dropdown-icon"></i>
                            </p>
                        </div>
                        {{-- <ul class="dropdown-menu bg-main"> --}}
                        <ul class="dropdown-menu bg-main dropdown-menu-end dropdown-menu-start">
                            <li>
                    ...
                    <form method="get"
                        action="{{ LaravelLocalization::getLocalizedURL(app()->getLocale() == 'ar' ? 'en' : 'ar') }}">
            ...
            @else
                <div class="d-flex gap-2">
                    ...
                    <button class="btn bg-white text-black rounded-4" data-bs-toggle="modal"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('site.home') }}#services">
                        {{ __('site.services') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('site.home') }}#binderies">
                        {{ __('site.binderies') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('site.home') }}#protofolios">
                        {{ __('site.portfolio') }}
                    </a>
                </li>
                <li class="nav-item">
