    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="text-white fw-lighter">
                <h2 class="fw-lighter">@lang('site.our') <strong class="text-gold">Black Muse</strong> @lang('site.our_services')</h2>
...
<section class="bg-main pt-5">
    <div class="container" id="binderies">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="text-white fw-lighter">
                <h2 class="fw-lighter">@lang('site.our') <strong class="text-gold">Black Muse</strong> @lang('site.portfolio_bindery')</h2>
            </div>
        </div>
