      ...
      @csrf
            ...
            <input type="hidden" name="package_id"    id="selectedPackageId">
           	@foreach($packages as $package)
	            ...
	            @endforeach  
	              ...
	              <button class="btn btn-choose-package" type="button"  data-package-id="{{ $package->id }}">
        ...
        <div class="overflow-auto">
          <div class="d-flex align-items-center justify-content-end gap-2 mt-4">
            ...
            <button type="button" id="nextBtn" onclick="nextPrev(1)" style="display: none;" class="btn bg-white rounded-4 text-black px-5">
