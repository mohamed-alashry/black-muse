...
@section('content')
    <!-- hero section -->
     @include('partials.site.hero-section', [
         'title' => 'Confirm  ',
         'highlight' => 'Booking',
         'breadcrumb' => $bookingData['service_name'] .' / '.$bookingData['package_name']
     ])
          ...
          <div class="row d-flex px-2 py-4">
            <div class="col-md-8">
              <div class="fw-lighter d-flex flex-column gap-4">
                ...
                <a class="btn border rounded-4 text-white w-50" href="{{url('/service-packages/'.$bookingData['service_id'])}}?booking_date={{$bookingData['booking_date']}}">
            ...
            <div class="col-md-4">
              <div class="down-package-card bg-main">
                <div class="header-card">
                  <h6>{{$bookingData['package_name']}}</h6>
                  <h3 class="text-gold">
                     {{ number_format($bookingData['total_price'], 0) }}
                    <span class="fs-6 fw-lighter">SAR</span>
                  </h3>
              ...
              <div class="rounded-5" style="border: 1px solid rgba(255, 255, 255, 0.1)">
                  <form method="POST" action="{{ route('service.booking.store') }}">
                      @csrf
